//===--- ExplicitCastCheck.h - clang-tidy -----------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_BSC_EXPLICITCASTCHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_BSC_EXPLICITCASTCHECK_H
...
/// http://clang.llvm.org/extra/clang-tidy/checks/bsc/explicit-cast.html
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_BSC_EXPLICITCASTCHECK_H
