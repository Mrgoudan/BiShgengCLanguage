...
bool Sema::IsSafeBuiltinTypeConversion(BuiltinType::Kind SourceType,
  ...
  static const bool EnableToConvert[15][15] = {
      ...
      {N, Y, Y, N, N, N, N, N, N, N, N, N, N, N},
      {N, Y, Y, Y, N, N, N, N, N, N, N, N, N, N},
      {N, Y, Y, Y, Y, N, N, N, N, N, N, N, N, N},
      {N, Y, Y, Y, Y, Y, N, N, N, N, N, N, N, N},
      {N, Y, N, N, N, N, Y, N, N, N, N, N, N, N},
      {N, Y, Y, N, N, N, N, Y, N, N, N, N, N, N},
      {N, Y, Y, Y, N, N, N, Y, Y, N, N, N, N, N},
      {N, Y, Y, Y, N, N, N, Y, Y, Y, N, N, N, N},
      {N, Y, Y, Y, Y, Y, N, Y, Y, Y, Y, N, N, N},
      {N, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, Y, N, N},
